...
public class LightRepository {
    private static final List<Light> All_LIGHTS = Arrays.asList(
            ...
            new Light("Ogrzewanie tylnej szyby", "defrost", "zielony", "ygnalizuje włączenie systemu ogrzewania tylnej szyby"),
            ...
            new Light("Lampka ostrzegawcza o stanie filtra paliwa", "water", "żółte", "Sygnalizuje obecność wody w filtra paliwa"),
            ...
            new Light("Lampka ostrzegawcza układu ABS", "abs", "zielony", "Sygnalizuje usterkę następujących podzespołów układu zapobiegania blokowaniu kół podczas hamowania (ABS)"),
